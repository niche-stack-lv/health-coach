...
// ─── LANDING PAGE DATA (unique to Arsh) ────────────────────────
const heroImage = "/clients/arsh-sandhu/Shades and Seasons of Life (2).jpg";
const aboutImage = "/clients/arsh-sandhu/Shades and Seasons of Life.jpg";

const bio = "Coach Arsh believes real progress isn't loud — it's in the quiet discipline of waking up, moving with purpose, and rebuilding self-respect one decision at a time. Based in Mohali, he brings a holistic approach to fitness that combines structured training, vegetarian-friendly nutrition, and lifestyle coaching.";
const bioSecondary = "No templates. Every plan is built for your body, your goals, and your life — personally crafted by Arsh himself. The SHREDCODE method is about sustainable transformation, not quick fixes.";

const achievements = [
  { image: "/clients/arsh-sandhu/Shades and Seasons of Life (1).jpg", value: "500+", label: "Clients Transformed" },
  { image: "/clients/arsh-sandhu/Life Shades and Seasons (1).jpg", value: "100%", label: "Vegetarian Plans" },
  { image: "/clients/arsh-sandhu/Life Shades and Seasons.jpg", value: "10+", label: "Years Experience" },
  { image: "/clients/arsh-sandhu/Shades and Seasons of Life (3).jpg", value: "5⭐", label: "Client Satisfaction" },
];
...
export default function ArshSandhuLanding() {
  return (
      ...
      <section className="bg-black pt-20 sm:pt-24 pb-6 sm:pb-8 text-center px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black uppercase leading-[0.92] sm:leading-[0.88] tracking-tight text-white">
            Transform Your
            <span className="block text-gradient-gold">Body &amp; Life</span>
            <span className="block">With SHREDCODE</span>
          </h1>
          <p className="mt-5 sm:mt-8 text-sm sm:text-base uppercase tracking-[0.2em] sm:tracking-[0.3em] text-zinc-300 font-light">
            by Arshpreet Singh Sandhu
          </p>
        </div>
      </section>
      ...
      <section className="relative bg-black">
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <Image src={heroImage} alt={config.coach.name} width={1200} height={800} className="w-full h-auto object-cover" priority />
      ...
      <section className="bg-black text-center px-4 sm:px-6 pt-4 sm:pt-6 pb-12 sm:pb-16">
        <div className="max-w-xl mx-auto">
          <Link href="/pricing"
            ...
            <span className="block text-sm sm:text-lg font-black uppercase tracking-[0.15em] sm:tracking-[0.2em]">Start Your Transformation</span>
            <span className="block text-[10px] sm:text-xs font-bold uppercase tracking-[0.12em] mt-1.5 animate-pulse">🔥 Pre-Launch Offer — Book Now</span>
          </Link>
      ...
      <section className="relative bg-black">
        ...
        <div className="hidden lg:grid lg:grid-cols-2">
          <div className="relative min-h-[70vh]">
            <Image src={aboutImage} alt={`Coach ${config.coach.firstName}`} fill className="object-cover object-top" sizes="50vw" />
        ...
        <div className="lg:hidden relative">
          <div className="relative h-[45vh]">
            <Image src={aboutImage} alt={`Coach ${config.coach.firstName}`} fill className="object-cover object-top" sizes="100vw" />
